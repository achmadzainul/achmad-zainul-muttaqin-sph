...
public class penilaian extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nim.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "nim", "1855201022", "1855201004", "1855201007", "1855201011", "1855201030", " " }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(5, 5, 5)
                                .addComponent(HDR, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void nimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nimActionPerformed
        ...
        String nama[] = {(""),"Iqbal Mubaroq","Achmad zainul","kana", "rijal","panji"};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int hadir, tugas, uts, uas, nilai, Nhuruf;

        hadir = Integer.parseInt(HDR.getText());
        tugas = Integer.parseInt(tgs.getText());
        uts = Integer.parseInt(UTS.getText());
        uas = Integer.parseInt(UAS.getText());

        nilai = (hadir * 10 / 100) + (tugas * 20 / 100) + (uts * 25 / 100) + (uas * 45 / 100);
